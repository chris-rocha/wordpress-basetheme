...
function mmgbase_scripts() {
	...
	wp_enqueue_style( 'mmgbase-style', get_stylesheet_uri(), array(), $rand );
	...
	wp_register_script('site-js', get_template_directory_uri() . '/js/site.bundle.js', array('jquery'), $rand, true);
